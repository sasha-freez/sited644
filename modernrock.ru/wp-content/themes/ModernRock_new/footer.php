	...
	<footer>
		<div class="fline">
			...
			<div class="copyright">
				&copy; 2026 modernrock.ru Использование материалов modernrock.ru разрешено только при 
				наличии активной ссылки на источник. Все права на изображения и тексты принадлежат их авторам.
			</div>	
		</div>
		<nav class="fmenu">
			<?php wp_nav_menu( array('menu' => 'MenuBottom', 'container' => '','menu_class' => 'menu_bottom', 'menu_id'=> 'menu_bottom')); ?>
		</nav>
		<div class="partners">
			<!-- noindex -->
