...
$sources = array(
    ...
    'minishop2_source_assets' => array(
        //'components/' . PKG_NAME_LOWER,
        'components/minishop2/payment/mspyacassa.php',
        'components/minishop2/payment/mspyacassahold.php'
    )
...
/**  minishop2 source assets */
foreach ($sources['minishop2_source_assets'] as $file) {
    $dir = dirname($file) . '/';
    $vehicle->resolve('file', array(
