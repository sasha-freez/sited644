...
var Gallery = (function() {
	...
	var $gallery = $( '#gr-gallery' ),
		...
		transEndEventName = support.transitions ? transProperties[ Modernizr.prefixed( 'transition' ) ].transitionEndEvent : '',
		transformName = support.transitions ? transProperties[ Modernizr.prefixed( 'transition' ) ].tranformName : '';
