...
// TBC : Removed    $p_header['stored_filename'] = $v_stored_filename;
    ...
    if (isset($p_options[PCLZIP_CB_PRE_ADD])) {
      ...
      // header.
      sprintf('$v_result = '.$p_options[PCLZIP_CB_PRE_ADD].'(PCLZIP_CB_PRE_ADD, $v_local_header);');
      if ($v_result == 0) {
...
//      if (is_file($p_filename))
    ...
    if (isset($p_options[PCLZIP_CB_POST_ADD])) {
      ...
      // Here I do not use call_user_func() because I need to send a reference to the
      // header.
      sprintf('$v_result = '.$p_options[PCLZIP_CB_POST_ADD].'(PCLZIP_CB_POST_ADD, $v_local_header);');
      if ($v_result == 0) {
        // ----- Ignored
        $v_result = 1;
      }
  ...
  function privExtractFile(&$p_entry, $p_path, $p_remove_path, $p_remove_all_path, &$p_options)
  {
    ...
    if (isset($p_options[PCLZIP_CB_PRE_EXTRACT])) {
      ...
      // Here I do not use call_user_func() because I need to send a reference to the
      // header.
      sprintf('$v_result = '.$p_options[PCLZIP_CB_PRE_EXTRACT].'(PCLZIP_CB_PRE_EXTRACT, $v_local_header);');
      if ($v_result == 0) {
        // ----- Change the file status
    ...
    elseif (isset($p_options[PCLZIP_CB_POST_EXTRACT])) {
      ...
      // Here I do not use call_user_func() because I need to send a reference to the
      // header.
      sprintf('$v_result = '.$p_options[PCLZIP_CB_POST_EXTRACT].'(PCLZIP_CB_POST_EXTRACT, $v_local_header);');
