...
function View() {
    ...
    var l, d, c, u, g = document.createElement("div"),
        h = "view";
    return function() {
        g.classList.add(h), t(), n(), e(), a(), l.setupAnimateIn(), setTimeout(i, 300), setTimeout(o, 2e3)
    }(), g
}
...
function BlockList(e, t) {
    ...
    function o(e) {
        h[w] && (h[w].setSelected(!1), h[w].mouseOut()), t(e.target.i), e.target.mouseOver()
    }

    function r(e) {
        h[w] && (h[w].setSelected(!0), h[w].mouseOver()), t(w), e.target.mouseOut()
    }
...
function IntroAnimation(e) {
    ...
    function a() {
        d.showImages(), d.animateAngle(), setTimeout(o, 2400) // время слайдинга после показа картинок
    }
    ...
    function s(t) {
        u.kill(), u = null, Model.MODE === Model.DEV_MODE ? e() : (setTimeout(d.animateIn, 600), setTimeout(a, 1e3))
    }
...
function IntroSliceList(e) {
    ...
    function s() {
        m = document.createElement("div"), m.classList.add(p + "__tagline"), m.innerHTML = Model.data.querySelector(".intro .tagline--one-line").innerHTML, u.appendChild(m), TweenLite.set(m, {
            z: 1
        })
    }
    ...
    function l() {
        for (var e = 0; e < f.length; e++) {
            ...
            if (TweenLite.set(t, {
                ...
                w.style.left = i + "px", g.style.left = w.style.left, m.style.left = w.style.left, window.innerWidth < 550 ? "desktop" === v && (v = "mobile", m.innerHTML = Model.data.querySelector(".intro .tagline").innerHTML) : "mobile" === v && (v = "desktop", m.innerHTML = Model.data.querySelector(".intro .tagline--one-line").innerHTML)
            }
        }
    }
...
function HomePanel(e) {
    function t() {
        Model.resizeManager.addEventListener(ResizeManager.RESIZE, g), w.addEventListener("click", function(e) {
            window.open("http://espn.com", "_blank")
        })
    }
    ...
    function o() {
        w = new SVGIcon("espn"), w.classList.add(y + "__espn"), v.appendChild(w)
    }
    ...
    function l() {
        ...
        e.classList.add(y + "__facebook"), L.appendChild(e);
        var t = new SVGIcon("twitter");
        t.classList.add(y + "__twitter"), L.appendChild(t), e.addEventListener("click", d), t.addEventListener("click", c), Modernizr.touch && (L.style.display = "none")
    }
    ...
    function g(e) {
        ...
        var u = window.innerWidth < 768 || window.innerHeight < 440 ? 135 : 175;
        L.style.display = c < u ? "none" : "block"
    }
...
function IntroSlice(e) {
    ...
    return l.resize = function() {
        ...
        function() {
            l.classList.add(d), e.getAttribute("data-mobile-offset") && (c = e.getAttribute("data-mobile-offset")), t(), l.resize()
        }(), l
}
...
function QuotePanel(e) {
    ...
    function n() {
        d = document.createElement("div"), d.classList.add(h + "__container"), d.innerHTML = e.querySelector(".athlete_quote").innerHTML, g.appendChild(d)
    }
    ...
    function a() {
        u = document.createElement("div"), u.classList.add(h + "__social-container"), d.appendChild(u), TweenLite.set(u, {
            z: 2
        });
        var e = new SVGIcon("facebook");
