...
wp_enqueue_style( 'main', get_template_directory_uri() . '/css/main.css', array( 'twentysixteen-style' ), '1' );
wp_enqueue_style( 'owl.carousel.min', get_template_directory_uri() . '/css/owl.carousel.min.css', array( 'twentysixteen-style' ), '1' );
wp_enqueue_style( 'owl.theme.default.min', get_template_directory_uri() . '/css/owl.theme.default.min.css', array( 'twentysixteen-style' ), '1' );
wp_enqueue_style( 'hamburgers', get_template_directory_uri() . '/css/hamburgers.css', array( 'twentysixteen-style' ), '1' );
wp_enqueue_style( 'slick', get_template_directory_uri() . '/css/slick.css', array( 'twentysixteen-style' ), '1' );
wp_enqueue_style( 'style', get_template_directory_uri() . '/css/style.css', array( 'twentysixteen-style' ), '1' );
wp_enqueue_style( 'template', get_template_directory_uri() . '/css/template.css', array( 'twentysixteen-style' ), time() );
wp_enqueue_style( 'timepicker', get_template_directory_uri() . '/css/timepicker.css', array( 'twentysixteen-style' ), time() );
	...
	wp_enqueue_script( 'timepicker', get_template_directory_uri() . '/js/timepicker.js', array( 'jquery' ), time(), true );
...
if( function_exists('acf_add_options_page') ) {
	...
	acf_add_options_page(array(
		'page_title' 	=> 'Опции темы ONLINE GIGER',
...
$columns['data_time'] = __( 'Дата и время события', 'my-plugin' );
...
if ( 'data_time' != $column_name )
return;
 
$price = get_post_meta($post_id, 'data_time', true);
if ( !$price )
...
if ( isset( $vars['orderby'] ) && 'data_time' == $vars['orderby'] ) {
...
function get_meta_for_gigdate() {
	...
	$dateContert = strtotime(get_post_meta(get_the_ID(), 'data_time', true));
	
	$month = date("m", $dateContert) - 1;

	$dateContert = ''.ceil(date("d", $dateContert)).' '.$arr[$month].' '.date("Y", $dateContert).'';

 return $dateContert;
}
function register_custom_extra_replacements() {
 wpseo_register_var_replacement( '%%gigdate%%', 'get_meta_for_gigdate', 'advanced', 'Дата концерта' );
}
