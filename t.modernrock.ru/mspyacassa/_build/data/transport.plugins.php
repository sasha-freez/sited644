...
$tmp = array(
    'mspYaCassa'                    => array(
        ...
        'description' => '',
        'events'      => array(
            'msOnManagerCustomCssJs' => array('priority' => 100),
            //'OnSiteSettingsRender'   => array('priority' => 100),
        )
    ),
    'mspYaCassaOnChangeOrderStatus' => array(
        'file'        => 'mspyacassa',
        'description' => '',
        'events'      => array(
            'msOnChangeOrderStatus' => array('priority' => 100)
        )
    )
