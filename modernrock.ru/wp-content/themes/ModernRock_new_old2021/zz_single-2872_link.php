		...
		<div class="one_ticket">
			...
			<div class="desc">
				...
				<?php if ($buyticket_1):?>
					...
					<div class="buy">
						<a href="https://spb.kassir.ru/kassir/mobile/desktop?redirect_url=/kassir/<?php echo $buyticket_1_radio; ?>/view/<?php echo $buyticket_1; ?>?iframedomain=modernrock" onclick="kassirWidget.summon({url:'https://spb.kassir.ru/kassir/mobile/desktop?redirect_url=/kassir/<?php echo $buyticket_1_radio; ?>/view/<?php echo $buyticket_1; ?>?iframedomain=modernrock'}); return false;" rel="nofollow" target="_blank">Купить билет</a>
					</div>
				<?php endif;?>
				
				<?php if ($buyticket_2):?>
					<script src="https://msk.kassir.ru/start.js"></script>
					<div class="buy <? if ($buyticket || $buyticket_4) echo 'kassir'; ?>">
						<a href="https://msk.kassir.ru/frame/event/<?php echo $buyticket_2; ?>?key=47fff075-4762-d3b1-95e6-95c7fe20d2b8" onclick="kassirWidget.summon({url:'https://msk.kassir.ru/frame/event/<?php echo $buyticket_2; ?>?key=47fff075-4762-d3b1-95e6-95c7fe20d2b8'}); return false;" rel="nofollow" target="_blank">Купить билет</a> 
				...
				<?php if ($buyticket_3):?>
					<div class="buy">
						<a href="http://concert.ru/widget/index.htm?actionId=<?php echo $buyticket_3; ?>&companyid=3576" rel="nofollow" target="_blank">Купить билет</a>
				...
				<?php if ($buyticket):?>
					<div class="buy">
						<a href="<?php echo $buyticket; ?>" rel="nofollow" target="_blank">Купить билет</a> 
				...
				<?php if ($buyticket_4):?>
					<div class="buy redkassa">
						...
						<button id="redkassa_popup" data-event="<?php echo $buyticket_4; ?>" data-href="/redkassa?event=<?php echo get_the_ID(); ?>" rel="nofollow" target="_blank">Купить билет</button>
