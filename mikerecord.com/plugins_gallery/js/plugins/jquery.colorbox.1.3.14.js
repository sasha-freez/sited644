...
(function ($, window) {
	...
	publicMethod.position = function (speed, loadedCallback) {
		...
		// this will adjust the load position of the overlay so that it is always at the top of the browser window
		if (settings.loadPosition == "loadTop") {
			if (posTop > $window.scrollTop() + 7 ){
