			...
			?>
				<div class="item">
					...
					<div class="buytickets">
						<div class="buy">
							<a href="<?php the_permalink(); ?>" title="<?php the_title();?> - купить билет на концерт">Купить билет</a>
						</div>
					</div>
				</div>
			<?php endwhile; ?>
