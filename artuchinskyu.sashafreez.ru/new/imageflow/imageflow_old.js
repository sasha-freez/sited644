...
function ImageFlow ()
{
	...
	this.defaults =
	{
		animationSpeed:     30,             /* Animation speed in ms */
		aspectRatio:        2.364,          /* Aspect ratio of the ImageFlow container (width divided by height) */
...
domReady(function()
{
	...
	instanceOne.init({ ImageFlowID:'basic_2' });
});