...
<div class="block_left">
	...
	<div class="bdetails d_leaks">
		...
		<?php 
			...
			if($ngroup){ $tmp_title = $ngroup;}else{$tmp_title = $group;}
		?>
	...
	<div class="others_txt txt_leaks">
		<p>
		Новый альбом
		<strong><?php echo $tmp_title;?> 
		"<?php echo get_post_meta(get_the_ID(), 'album', true);?>" (<?php echo get_post_meta(get_the_ID(), 'data_leaks', true);?>)</strong>
		...
		<p>Здесь же вы сможете <strong>слушать онлайн альбом 
		<?php echo $tmp_title;?> 
		"<?php echo get_post_meta(get_the_ID(), 'album', true);?>"</strong> (<?php echo get_post_meta(get_the_ID(), 'data_leaks', true);?>) 
		и при желании приобрести его на iTunes. Все необходимые ссылки прикреплены к посту.</p>
	</div>
	<?php endwhile; ?>
	<?php endif; ?>
